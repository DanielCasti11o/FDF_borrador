...
/*   Updated: 2025/03/08 05:29:36 by dacastil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	slops(t_ejes *eje, int x, int y)
{
...
void	alg_bressenham(t_ejes *eje)
{
	...
	eje->pos_x1 *= eje->zoom;
	eje->pos_y1 *= eje->zoom;
	// ft_isometric(&eje->pos_x, &eje->pos_y, z);
	// z += eje->modif_hight;
	// if (z > 0 && z1 > 0)
	// {
	// 	z += eje->modif_hight;
	// 	z1 += eje->modif_hight;
	// eje->pos_x += eje->modif_hight;
	// eje->pos_y += eje->modif_hight;
	// eje->pos_x1 += eje->modif_hight;
	// eje->pos_y1 += eje->modif_hight;
	// }
